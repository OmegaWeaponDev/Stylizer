...
public class DebugCommand extends GlobalCommand {
  ...
  private void debugPlayer(final Player player) {
    ...
    Utilities.message(player,
      "#14abc9===========================================",
      " #6928f7OmegaNames #ff4a4av" + plugin.getDescription().getVersion() + " #14abc9By OmegaWeaponDev",
      "#14abc9===========================================",
      ...
      " #14abc9OmegaNames Commands: #ff4a4a" + Utilities.setCommand().size() + " / 5 #14abc9registered",
  ...
  private void debugConsole() {
    ...
    Utilities.logInfo(true,
      "===========================================",
      " OmegaNames v" + plugin.getDescription().getVersion() + " By OmegaWeaponDev",
      "===========================================",
      ...
      " OmegaNames Commands: " + Utilities.setCommand().size() + " / 5 registered",
